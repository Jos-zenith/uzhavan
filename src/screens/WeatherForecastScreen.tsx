      ...
      {error && (
        <div style={{ 
          ...
          <div style={{ marginTop: '10px', fontSize: '14px' }}>
            💡 <strong>Tip:</strong> Set your API key in <code>.env</code> and restart the app:
      ...
      {!weather && !loading && !error && (
        <div style={{ 
          ...
          <ol style={{ textAlign: 'left', display: 'inline-block' }}>
            ...
            <li>Create <code>.env</code> in the app root</li>
            <li>Add: <code>REACT_APP_OPENWEATHER_API_KEY=YOUR_KEY</code></li>
